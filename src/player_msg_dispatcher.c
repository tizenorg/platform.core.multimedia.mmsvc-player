...
static void __player_callback(_player_event_e ev, muse_module_t module)
{
...
static void _seek_complate_cb(void *user_data)
{
	...
	__player_callback(ev, (muse_module_t)user_data);
}
...
static void _buffering_cb(int percent, void *user_data)
{
	...
	muse_module_t module = (muse_module_t)user_data;
		...
		void *data, bool set)
{
	...
	muse_module_t module = (muse_module_t)data;
...
static int player_disp_set_callback(muse_module_t module)
{
	intptr_t handle;
...
static int player_disp_create(muse_module_t module)
{
	int ret = -1;
	player_h player;
...
static int player_disp_set_uri(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_prepare(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_prepare_async(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_unprepare(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_destroy(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_start(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_stop(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_pause(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_memory_buffer(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_deinit_memory_buffer(muse_module_t module)
{
	intptr_t bo_addr;
	tbm_bo bo;
...
static int player_disp_set_volume(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_volume(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_state(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_play_position(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_play_position(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_display(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_mute(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_is_muted(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_duration(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_sound_type(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_audio_policy_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_latency_mode(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_latency_mode(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_looping(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_is_looping(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_display_mode(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_display_mode(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_playback_rate(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_display_rotation(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_display_rotation(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_display_visible(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_is_display_visible(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_content_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_codec_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_audio_stream_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_video_stream_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_video_size(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_album_art(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_eq_bands_count(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_eq_all_bands(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_eq_band_level(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_eq_band_level(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_eq_level_range(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_eq_band_frequency(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_eq_band_frequency_range(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_eq_clear(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_eq_is_available(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_subtitle_path(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_subtitle_position_offset(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_progressive_download_path(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_progressive_download_status(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_capture_video(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_streaming_cookie(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_streaming_user_agent(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_streaming_download_progress(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static gpointer _player_push_media_stream_handler(gpointer param)
{
	muse_module_t module = (muse_module_t)param;
	char *buf;
	push_data_q_t *qData;
...
static int player_disp_push_media_stream(muse_module_t module)
{
	int ret = MEDIA_FORMAT_ERROR_NONE;
	intptr_t handle;
...
static int player_disp_set_media_stream_info(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_media_packet_finalize_cb(muse_module_t module)
{
	media_packet_h packet;
...
static int player_disp_set_media_stream_buffer_max_size(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_media_stream_buffer_max_size(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_media_stream_buffer_min_threshold(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_media_stream_buffer_min_threshold(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_track_count(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_current_track(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_select_track(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_get_track_language_code(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_pcm_extraction_mode(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
static int player_disp_set_pcm_spec(muse_module_t module)
{
	int ret = -1;
	intptr_t handle;
...
int (*dispatcher[MUSE_PLAYER_API_MAX]) (muse_module_t module) = {
