...
def make_body(ListFileName, ServerFileName, ClientFileName):
	...
	with open(ServerFileName, "a") as ServerFile:
		ServerFile.write("\n")
		ServerFile.write("int player_disp_" + ApiName + "(muse_module_h module)\n")
		ServerFile.write("{\n")
		ServerFile.write("\tint ret = PLAYER_ERROR_NONE;\n")
		ServerFile.write("\tmuse_player_handle_s *muse_player = NULL;\n")
		ServerFile.write("\tmuse_player_api_e api = MUSE_PLAYER_API_" + ApiName.upper() +";\n")
		ServerFile.write("\n")
		ServerFile.write("\tmuse_player = (muse_player_handle_s *)muse_core_ipc_get_handle(module);\n")
		ServerFile.write("\n")
		ServerFile.write("\tret = ACTUAL_OPERATION_FUNCTION(muse_player->player_handle); /* Template Guide: add legacy_player_function with parames. */\n")
		ServerFile.write("\n")
